...
metadata:
  ...
  preferred_nodes: []
  capability_summary: Automate Electron desktop apps using agent-browser via Chrome DevTools Protocol
  openclaw_surfaces:
  - codex
  depends_on: []
